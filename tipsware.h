...
// 응용 프로그램이 사용하는 제목입니다. (수정 가능)     * 수정 *  원문 : https://blog.naver.com/tipsware
const char *gp_window_title = "Minesweeper";
// 응용 프로그램이 사용할 메뉴의 ID입니다. (0이면 메뉴를 사용하지 않는다는 뜻입니다.)     * 수정 *  원문 : 0
int g_menu_id = IDC_MINESWEEPER;
